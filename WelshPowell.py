...
if __name__ == '__main__':
    wp = WelshPowell()
    Noeud1 = Noeud(1, 1, "1", "1", "1", "1", "1", datetime(2025, 11, 27, 9, 0, 0), datetime(2025, 11, 27, 10, 0, 0))
    Noeud2 = Noeud(2, 2, "2", "2", "2", "2", "2", datetime(2025, 11, 28, 9, 0, 0), datetime(2025, 11, 28, 10, 0, 0))
